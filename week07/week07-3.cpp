...
public:           ///vector是C++ 的陣列，伸縮自如，但是2D比較難寫
    string tictactoe(vector<vector<int>>& moves) {
        int a[3][3]={}; ///C語言的陣列 ，大一教過，必較簡單 {}大括號代表初始值，「裡面空的」代表都是0
        int now=1; ///現在玩家 1:玩家A，2:玩家B
        int winner = 0; ///還沒找得到得勝的玩家
